    		...
    		<div class="collapse navbar-collapse" id="navbarSupportedContent">
      			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
						...
						@guest
							<li>
								<a class="btn btn-dark" href="{{ route('user.register') }}" aria-expanded="false">
									Register
								</a>
							</li>
					
							<li>
								<a class="btn btn-dark" href="{{ route('user.login') }}" aria-expanded="false">
									Login
								</a>
							</li>
						@endguest
						...
						@auth
							<li>
								...
								<a class="btn btn-dark" href="{{ route('logout') }}" aria-expanded="false"
